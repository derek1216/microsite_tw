    ...
    <body>
        ...
        <div id="pmenu_block">
            <div id="pmenu_box" class="navbar">
                <div class="container">
                    <span class="brandname brand" href="#" style="white-space: nowrap"><a href="/products/productFind.php?catid=6#8,544+遠端KVM多電腦切換器+" target="_blank">KVM over IP - KN8 Series</a></span>
                        ...
                        <div id="pmenu" class="nav-function collapse nav-collapse navCollapseToggle">
                            <nav class="row">
                                <ul class="nav highlights" style="left:10px\9;">
                                    ...
                                    <li><a href="?p=Features" target="_self" style="text-align:right\9;">Features</a></li>
                                    <li><a href="?p=Solution" target="_self" >Solutions</a></li>
                                    <li><a href="?p=Anatomy" target="_self" >Anatomy</a></li>
                                    <li><a href="?p=Application" target="_self">Applications</a></li>
                                    <!--<li><a data-url="https://youtu.be/2a-hVKoPhRE" data-toggle="lightbox" href="#demoLightbox" target="_blank" class="Button_Lightbox indexVideo_click">Video</a></li>-->
                                 <!--<li><a href="?p=Contactus" target="_self">Contact Us</a></li>-->
                                    <li id="special"><a href="?p=OnlineTrial" target="_self">Online Trial</a></li>
                                </ul>
                            </nav>
                            <!-- menu 第一層 end--> 
                        </div><!--pmenu-end --> 
                ...
                if (!$.ismobile()) {
                    ...
                    $(".indexVideo_click").click(function () {
                        if ($(".indexVideo").find("iframe").length ==0) {
                            $(".indexVideo").append('<iframe width="998" height="662" src="http://www.youtube.com/embed/2a-hVKoPhRE?rel=0&wmode=opaque&cc_load_policy=1;vq=hd1080" frameborder="0" allowfullscreen></iframe>');
                        }
                    });
