    ...
    <body>
        ...
        <div id="pmenu_block">
            <div id="pmenu_box" class="navbar">
                <div class="container">
                    <span class="brandname brand" href="#" style="white-space: nowrap"><a href="/products/productFind.php?catid=12#8,544+KVM over IP Switches+" target="_blank">KVM over IP - KN8 Series</a></span>
            ...
            <div class="container">
                ...
                <div class="row-fluid icon_subblock Animation" data-animation="zoomIn2">
                    ...
                    <div class="span4 icon_content">
                        <a class="IconAnimation ui-link" target="_blank" href="/products/productFind.php?catid=12#8,544+KVM over IP Switches+">
                            <div class="row-fluid">
