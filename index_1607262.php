...
<html lang="en">
    <head>
        ...
        <!-- Le styles -->
        <?php
        include_once("../../../../ext_libraries/getFuncs.php");
        ...
        <link href="/ext_data/global_en/microsite/css/font_noto_asian_TW.css" rel="stylesheet" type="text/css" /><!--  asian_繁體中文_webfont 字型定義 -->
...
<!-- End Google Tag Manager -->
        ...
        <div id="pmenu_block">
            <div id="pmenu_box" class="navbar">
                <div class="container">
                    <span class="brandname brand" href="#" style="white-space: nowrap"><a href="<?php echo getProudctlinkfromMicrosite("kn8");?>" target="_blank">KVM 多電腦切換器 － KN8 系列</a></span>
            ...
            <div class="container">
                ...
                <div class="row-fluid icon_subblock Animation" data-animation="zoomIn2">
                    ...
                    <div class="span4 icon_content">
                        <a class="IconAnimation ui-link" target="_blank" href="<?php echo getProudctlinkfromMicrosite("kn8");?>">
                            <div class="row-fluid">
